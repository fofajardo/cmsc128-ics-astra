...
describe('Projects API Tests', function () {
    ...
    describe('GET /v1/projects/:projectId', function () {
        ...
        // Test case to verify that the API returns 400 if the projectId format is invalid
        it('should return 400, status FAILED, and a message when projectId format is invalid', async function () {
            const invalidProjectId = '00000000-0000-0000-0000-000000000000'; // Invalid projectId
