...
export default function SearchBar() {
    ...
    <form className="bg-astrawhite w-4xl h-[55px] rounded-2xl shadow-[0_4px_4px_rgba(0,0,0,0.25)] py-6 flex items-center justify-between gap-2 mb-4">
        <div className="h-full flex items-center gap-3 ml-3 w-full">
            ...
            <input type="text" placeholder="Search for job title" className="font-normal text-sm text-astradarkgray outline-none focus:border-b-1 border-0 border-astraprimary/50 focus:pb-1 w-full transition-all duration-150 ease-in"></input>
        </div>
