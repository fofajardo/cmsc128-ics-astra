export default function ConfirmationPrompt({isEdit, close, isAdd, object, handleConfirm}){
    return (
    <div className="fixed inset-0 bg-astrablack/60 flex items-center justify-center z-100">
        <div className="bg-astrawhite max-w-[600px] w-19/20 min-h-[100px] h-auto rounded-2xl p-7 pb-5">
            ...
            <h1 className="text-astrablack text-xl font-normal">Are you sure you want to {isEdit ? "edit": isAdd ? 'post' : "delete"} this job posting?</h1>
