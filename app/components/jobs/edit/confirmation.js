export default function ConfirmationPrompt({isEdit, close, object, handleConfirm}){
    return (
    <div className="fixed inset-0 bg-astrablack/60 flex items-center justify-center z-100">
        <div className="bg-astrawhite max-w-[600px] w-19/20 min-h-[100px] h-auto rounded-2xl p-7 pb-5">
            ...
            <div className="flex gap-4 mt-3">
                <button onClick={handleConfirm(object)} className="!cursor-pointer text-astrawhite border-1 border-astraprimary bg-astraprimary font-semibold w-16 py-2 rounded-lg text-lg">Yes</button>
