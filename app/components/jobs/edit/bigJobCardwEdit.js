...
export default function BigJobCardwEdit(job) {
    ...
    <div className="bg-astrawhite max-w-[1250px] min-w-[750px] w-19/20 min-h-[308px] h-auto rounded-2xl shadow-[0_4px_4px_rgba(0,0,0,0.25)] p-10 pb-7">
        ...
        <div className="flex items-start gap-2">
            ...
            <button onClick={()=>{setForm(true)}} className="!cursor-pointer text-astrawhite border-1 border-astraprimary bg-astraprimary font-semibold w-16 py-2 rounded-lg text-lg">Edit</button>
            <button onClick={()=>{setPrompt(true)}} className="!cursor-pointer text-astraprimary border-1 border-astraprimary font-semibold w-20 py-2 rounded-lg text-lg">Delete</button>
        </div>
