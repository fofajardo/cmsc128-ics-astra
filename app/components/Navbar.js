    ...
    >
      <div className="flex items-center justify-between max-w-screen-xl mx-auto h-full px-12 w-[1440px]">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/signin">
            <button className="cursor-pointer px-5 py-1.5 min-w-[110px] h-[42px] font-bold text-astrawhite bg-astraprimary border-2 border-astraprimary rounded-[15px] transition-all duration-300 transform hover:scale-105 hover:shadow-astraprimary">
              Sign In
            </button>
          </Link>
          <Link href="/signup">
            <button className="cursor-pointer px-5 py-1.5 min-w-[110px] h-[42px] font-bold text-astraprimary bg-astrawhite border-2 border-astraprimary rounded-[15px] transition-all duration-300 transform hover:scale-105 hover:shadow-astraprimary">
              Sign Up
            </button>
          </Link>
        </div>
