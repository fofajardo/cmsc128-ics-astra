...
export default function AddExperienceModal({ onClose }) {
  ...
  const employmentTypes = ["Full-time", "Part-time", "Contractual", "Internship"];
  ...
  const handleSubmit = (e) => {
    ...
    setShowToast({ type: "success", message: "Experience added successfully!" });
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={handleChange}
              className="h-4 w-4 text-blue-600 border-gray-300 rounded text-sm md:text-base"
            />
