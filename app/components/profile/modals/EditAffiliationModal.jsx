...
export default function EditAffiliationModal({ affiliation, onClose }) {
  ...
  useEffect(() => {
    if (affiliation) {
      const [startMonth, startYear] = affiliation.startDate.split(" ");
      let endMonth = "", endYear = "";

      if (affiliation.endDate && affiliation.endDate !== "Present") {
        [endMonth, endYear] = affiliation.endDate.split(" ");
      }
      ...
      <div className="w-full max-w-3xl max-h-screen overflow-y-auto bg-white rounded-lg shadow-lg p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl md:text-2xl font-bold">Edit Affiliation</h2>
