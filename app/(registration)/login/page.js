  ...
  return (
    <div className="form-background">
      <div className="form-card">
        ...
        <div className="mt-6">
          <button className="w-full border border-border-color bg-white  hover:bg-gray-300 rounded-md py-2 px-4 flex items-center justify-center hover:bg-light-blue transition-colors">
            <div className="user-icon">
              <User size={18} className="text-[var(--medium-gray)]" />
            </div>
            <span className="text-sm text-black ">Continue as Guest</span>
          </button>
        </div>
      </div>
    </div>
