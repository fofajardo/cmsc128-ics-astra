        ...
        <div className="px-6 sm:px-8 lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-4 md:pt-0">
          <div className="md:hidden bg-gray-100 p-4 mb-4 rounded-lg"> {/* For Mobile */}
            ...
            <p className="text-sm mb-2">
              ...
              This document serves as official verification of your academic achievement.
            </p>
            <p className="text-sm">
          ...
          <form className="space-y-3">
            <div>
              <label htmlFor="degree-program" className="signup-additional-steps-text">
                Degree Program
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="student-id" className="signup-additional-steps-text">
                Student ID
              </label>
              <input type="text" id="student-id" name="student-id" placeholder="XXXX-XXXXX" className="form-input" />
            </div>

            <div>
              <label htmlFor="graduation-year" className="signup-additional-steps-text">
                Graduation Year
              </label>
              <input
                type="text"
            ...
            <div className="max-w-md mx-auto">
              <label className="signup-additional-steps-text">Proof of Graduation</label>
              <input
                type="file"
            ...
            <div className="flex gap-4">
              <Link href="/signup/2" className="w-1/3">
