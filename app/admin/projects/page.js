...
import { Check, Wallet, Users, HeartHandshake, GraduationCap, FileEdit, Trash2 } from "lucide-react";
            ...
            >
                <div onClick={e => e.stopPropagation()} className="bg-astrawhite p-8 rounded-xl w-80">
                  ...
                  <div className="flex flex-col gap-4">
                    <div>
                      <label className="font-s text-astradarkgray mb-2 block">Project Type</label>
                      <select 
            ...
            <div className="pt-6 pb-4 overflow-y-scroll w-full scrollbar-hide">
                    <div className="flex flex-row gap-3 min-w-max px-4 justify-center"> 
                        <AdminStatCard 
                          title='Active Drives' 
                          value={8} 
                          icon={<HeartHandshake className='size-13 text-astrawhite' strokeWidth={1.5}/>} 
                          route={false} 
                        ...
                        <AdminStatCard 
                          title='Total Raised' 
                          value="₱1.2M" 
                          icon={<Wallet className='size-13 text-astrawhite' strokeWidth={1.5}/>} 
                          route={false}
                        />
                        <AdminStatCard 
                          title='Contributors' 
                          value={258} 
                          icon={<Users className='size-13 text-astrawhite' strokeWidth={1.5}/>} 
                          route={false}
                        />
                    </div>
            </div>
            ...
            <div className='flex flex-col py-4 px-1 md:px-4 lg:px-8'>
                ...
                <div className="bg-astrawhite shadow-md p-6 rounded-b-xl">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {currTab === 'Pending' && currentProjects.map(project => (
                      <ProjectCardPending 
                        key={project.id}
                        id={project.id}
                        image={project.image}
                    ...
                    {(currTab === 'Active' || currTab === 'Inactive') && currentProjects.map(project => (
                      <ProjectCardActive 
                        key={project.id}
                        id={project.id}
                        image={project.image}
                  ...
                  {currentProjects.length === 0 && (
                    <div className="text-center py-12">
                      <p className="text-astradarkgray font-s">No {selectedType.toLowerCase() !== 'all' ? selectedType.toLowerCase() : ''} projects found.</p>
                    </div>
                  )}
                </div>
...
const projectsData = [
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Raising funds to upgrade the programming laboratory with new computers, software licenses, and modern teaching equipment.",
        goal: "₱750,000",
        raised: "₱420,000",
        donors: 67,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Help us renovate the aging ICS building with modern facilities, air conditioning, and student collaboration spaces.",
        goal: "₱1,200,000",
        raised: "₱185,000",
        donors: 29,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Creating a structured mentorship program connecting alumni with current students for career guidance and professional development.",
        goal: "₱100,000",
        raised: "₱0",
        donors: 0,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Expanding our digital and physical library resources with the latest textbooks, journals, and access to premium online learning platforms.",
        goal: "₱200,000",
        raised: "₱76,000",
        donors: 31,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Supporting our annual hackathon event with prizes, food, equipment, and guest speakers from the tech industry.",
        goal: "₱150,000",
        raised: "₱84,000",
        donors: 23,
    ...
    },
    {
        ...
        type: "Scholarship",
        image: "/projects/assets/Donation.jpg",
        description: "Supporting first-generation college students pursuing computer science degrees with financial aid and mentoring support.",
        goal: "₱350,000",
        raised: "₱0",
        donors: 0,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Celebrating 25 years of excellence with an alumni gathering, commemorative book, and establishment of new student programs.",
        goal: "₱500,000",
        raised: "₱125,000",
        donors: 87,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Creating a dedicated game development laboratory with high-performance workstations, VR equipment, and industry-standard software.",
        goal: "₱800,000",
        raised: "₱0",
        donors: 0,
    ...
    },
    {
        ...
        type: "Scholarship",
        image: "/projects/assets/Donation.jpg",
        description: "Providing financial support for ICS students participating in international exchange programs with partner universities.",
        goal: "₱400,000",
        raised: "₱320,000",
        donors: 28,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Hosting an annual career conference bringing together alumni, industry leaders, and students for networking and job opportunities.",
        goal: "₱120,000",
        raised: "₱35,000",
        donors: 14,
    ...
    },
    {
        ...
        type: "Scholarship",
        image: "/projects/assets/Donation.jpg",
        description: "Supporting indigenous students pursuing computer science education with comprehensive scholarships and cultural support programs.",
        goal: "₱275,000",
        raised: "₱120,000",
        donors: 19,
    ...
    },
    {
        ...
        type: "Scholarship",
        image: "/projects/assets/Donation.jpg",
        description: "Rewarding students who demonstrate exceptional innovation and creativity in their technology projects and academic work.",
        goal: "₱200,000",
        raised: "₱0",
        donors: 0,
    ...
    },
    {
        ...
        type: "Fundraiser",
        image: "/projects/assets/Donation.jpg",
        description: "Developing a robust digital platform to connect alumni, facilitate mentorship, share job opportunities, and strengthen our community.",
        goal: "₱180,000",
        raised: "₱65,000",
        donors: 42,
