  ...
  return (
    <div className="w-full max-w-4xl">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Edit Work Experience</h2>
        <button onClick={hideExperienceForm} className="text-gray-500 hover:text-gray-700">
      ...
      <div className="mb-6">
        <button
          onClick={() => (window.location.href = "/AddExperience")}
