  ...
  return (
    <div className="w-full max-w-full sm:max-w-2xl px-4 sm:px-6 md:px-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={hideTechnicalForm} className="text-gray-500 hover:text-gray-700">
      ...
      <div className="flex flex-wrap justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button
            onClick={handleSave}
            className="text-sm md:text-base px-2 py-1 md:px-4 md:py-2 bg-[var(--color-astraprimary)] text-white rounded-lg hover:bg-blue-700"
          >
            Save
          </button>
        </div>
